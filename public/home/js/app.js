...
function noty(message) {
  ...
  var title = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'اخطار';
  var position = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'topCenter';
  iziToast.show({
    title: title,
    color: color,
    position: position,
  ...
  if (jQuery) {
    ...
    $('#go_to_user_panel').click(function () {
      ...
      if (show) {
        ...
        if (email.length < 4) {
          noty('لطفا ایمیل  خود را به درستی وارد نمایید  '); // return
        }
        ...
        if (mobile.length < 11) {
          noty('لطفا تلفن همراه خود را به درستی وارد نمایید  '); // return
        }
      ...
      var res = lara_ajax('/user_create', str);
    ...
    $('#insert_new_user_comment').click(function () {
      ...
      comment = comment.trim(); // if (comment.length<10){
      ...
      if (all[0] == 'status') {
        ...
        close_popup();
        noty(user_name + '     نظرت ثبت شد ', 'green', '  ثبت   ');
      }
    ...
    $('#cal_bmi').click(function () {
      var weight = $('#weight_inp').val();
      weight = Number(weight);
      var height = $('#height_inp').val();
      height = Number(height);
      var new_height = height / 100;
      var bmi = weight / (new_height * new_height); // bmi= Math.round(bmi * 10) / 10
...
__webpack_require__(/*! G:\laravelProject\horosfit\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! G:\laravelProject\horosfit\resources\sass\app.scss */"./resources/sass/app.scss");
